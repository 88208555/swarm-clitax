...
export async function run(request) {
  ...
  if (operation === "blueprint-bridge") {
    ...
    return okResponse(requestId, {
      ...
      blueprintRequest,
      nextStep: { operation: "dispatch", instruction: "POST the blueprintRequest to ${ALLOWED_EXTERNAL_ENDPOINTS.blueprint} (operation compile-inline) to get the traceable blueprint, then dispatch its tasks to the swarm workers." },
    });
  }
